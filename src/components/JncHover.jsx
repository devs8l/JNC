...
const JncHover = () => {
    ...
    return (
        <div className="relative w-full my-10">
            ...
            <div
                className="relative w-full h-[60vh] mx-auto overflow-hidden cursor-pointer"
            ...
            >
                ...
                <div className="relative h-full">
                    ...
                    <div className={`absolute inset-0 flex flex-col items-center justify-center p-6 bg-white z-10 ${
                        isHovered ? 'opacity-0 transition-opacity duration-200' : 'opacity-100 transition-opacity duration-500'
                    }`}>
                    ...
                    <div className={`absolute inset-0 flex flex-col items-center justify-center p-6 bg-blue-500 z-30 ${
                        isHovered ? 'opacity-100 transition-opacity duration-500' : 'opacity-0 transition-opacity duration-200'
                    }`}>
                    ...
                    >
                        ...
                        <div className="flex items-center justify-center gap-4">
                            ...
                            <div className={`h-px w-8 border-t-2 border-dashed border-white ${
                                isHovered ? 'opacity-100 transition-opacity duration-500' : 'opacity-0 transition-opacity duration-200'
                            }`}></div>
