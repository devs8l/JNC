...
const BlogPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 md:px-8 py-8">
      <h1 className="text-3xl text-center mb-3">Blogs</h1>
      <p className="text-gray-700 text-sm text-center mb-12">Stories, insights, and ideas shaping tomorrow's healthcare</p>
